...
This repository contains the complete implementation and documentation for the minor project assignment, demonstrating serial communication over USB/UART using a microcontroller and a terminal emulator.
